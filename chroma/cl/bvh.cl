...
extern "C"
{
  ...
  __kernel void  node_area(__constant unsigned int first_node,
			   __constant unsigned int nnodes_this_round,
  ...
  __kernel void
  make_leaves(__global unsigned int first_triangle,
	      __global unsigned int ntriangles, 
	      __global uint3 *triangles, __global float3 *vertices,
	      __constant float3 world_origin, __constant float world_scale,
  ...
  __kernel void
  reorder_leaves(__constant unsigned int first_triangle,
		 __constant unsigned int ntriangles,
  ...
  __kernel void
  build_layer(__constant unsigned int first_node,
	      __constant unsigned int n_parent_nodes, 
	      __constant unsigned int n_children_per_node,
	      __global uint4 *nodes,
	      __constant unsigned int parent_layer_offset,
	      __constant unsigned int child_layer_offset)
  {
    unsigned int thread_id = get_local_size(0)*get_group_id(0) + get_local_id(0); // unsigned int thread_id = blockDim.x * blockIdx.x + threadIdx.x;
  ...
  __kernel void
  make_parents_detailed(__constant unsigned int first_node,
			__constant unsigned int elements_this_launch, 
  ...
  __kernel void
  make_parents(__constant unsigned int first_node,
	       __constant unsigned int elements_this_launch, 
	       __constant unsigned int n_children_per_node,
	       __global uint4 *parent_nodes,
	       __global uint4 *child_nodes,
	       __constant unsigned int child_id_offset,
	       __constant unsigned int num_children)
  {
    unsigned int thread_id = get_local_size(0)*get_group_id(0) + get_local_id(0); // unsigned int thread_id = blockDim.x * blockIdx.x + threadIdx.x;
    if (thread_id >= elements_this_launch)
      return;
  ...
  __kernel void
  copy_and_offset(__constant unsigned int first_node,
		  __constant unsigned int elements_this_launch, 
		  __constant unsigned int child_id_offset,
  ...
  __kernel void distance_to_prev(__constant unsigned int first_node, 
				 __constant unsigned int threads_this_round,
                                 __global uint4 *node, 
  ...
  __kernel void pair_area(__constant unsigned int first_node,
			  __constant unsigned int threads_this_round,
  ...
  __kernel void distance_to(__constant unsigned int first_node, 
			    __constant unsigned int threads_this_round,
			    __constant unsigned int target_index,
			    __global uint4 *node, 
			    __global unsigned int *area)
  {
    unsigned int thread_id = get_local_size(0)*get_group_id(0) + get_local_id(0); // unsigned int thread_id = blockDim.x * blockIdx.x + threadIdx.x;
  ...
  __kernel void min_distance_to( __constant unsigned int first_node, __constant unsigned int threads_this_round,
				 __constant unsigned int target_index,
				 __global uint4 *node,
				 __constant unsigned int block_offset,
  ...
  __kernel void swap(__constant unsigned int a_index, __constant unsigned int b_index,
		     __global uint4 *node)
  {
  ...
  __kernel void collapse_child(__constant unsigned int start, __constant unsigned int end,
			       __global uint4 *node)
  {
    unsigned int thread_id = get_local_size(0)*get_group_id(0) + get_local_id(0); // unsigned int thread_id = blockDim.x * blockIdx.x + threadIdx.x;
  ...
  __kernel void area_sort_child(__constant unsigned int start, __constant unsigned int end,
